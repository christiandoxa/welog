...
`Welog` uses a configuration struct to set up the ElasticSearch connection parameters. The `Config` struct allows you to
define ElasticSearch URL, username, password, and index name:
